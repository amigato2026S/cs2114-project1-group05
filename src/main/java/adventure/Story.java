...
public final class Story {
    ...
    public static GenTree build() {
        ...
        Chapter ch2a = new Chapter(
                ...
                new String[]{"Take the key and try the door", "Crawl toward the water sound"});

        Chapter ch2b = new Chapter(
                "The footsteps stop. A gruff voice on the other side grumbles and "
                        + "the door creaks open a crack.",
                new String[]{"Push past and run", "Talk your way out"});
        ...
        Chapter ch3b = new Chapter(
                ...
                new String[]{"Swim with the current", "Climb back out"});
        ...
        GenTree tree = new GenTree(ch1);
        tree.addChild(ch1, ch2a, 1);
        tree.addChild(ch1, ch2b, 2);

        tree.addChild(ch2a, ch3a, 1);
        tree.addChild(ch2a, ch3b, 2);

        tree.addChild(ch2b, ch3c, 1);
        tree.addChild(ch2b, ch3d, 2);

        tree.addChild(ch3b, ch4a, 1);
        tree.addChild(ch3b, ch4b, 2);
